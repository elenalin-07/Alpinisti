...
public class GliAlpinisti {
    ...
    public static void main(String[] args) {
        ...
        **/
        ...
        System.out.println("non e riuscito a scalare la montagna di " + cima + " passi e ha scalato " + n_montagna + " montagne");
    }
